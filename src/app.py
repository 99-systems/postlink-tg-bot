...
from src.handlers.request import send_request as send_request_handler, deliver_request as deliver_request_handler, \
    manage_request as manage_request_handler
...
async def run():
    ...
    send_request_handler.router.message.middleware(
        OpenRequestMessageMiddleware())  # проверяет на наличие открытой заявки
